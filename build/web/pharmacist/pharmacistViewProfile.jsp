<%-- 
    Document   : pharmacistViewProfile
    Created on : Dec 26, 2019, 2:07:59 AM
    Author     : HP-PAVILION
--%>
              ...
              <div class="col-md-12">
                ...
                <div class="collapse navbar-collapse navbar-right" id="myNavbar">
                  <ul class="nav navbar-nav">
                       ...
                       <li class=""><a href="PharmacistController">Prescription</a></li>
                    ...
                    <div class="sign-up">
                            ...
                            <form action="PharmacistController" method="post">
                                    ...
                                    <table align="center" border="1">
                                        ...
                                        <td><c:out value = "${pharmacistInfo.name}" /></td>
                                        </tr>
                                        <tr>
                                            <th bgcolor="#008A8A">E-MAIL</th>
                                            <td><c:out value = "${pharmacistInfo.email}" /></td>
                                        </tr>
                                        <tr>
                                            <th bgcolor="#008A8A">PHONE NUMBER</th>
                                            <td><c:out value = "${pharmacistInfo.phone}" /></td>
                                        </tr>
                                        <tr>
                                            <th bgcolor="#008A8A">DATE OF BIRTH</th>
                                            <td><c:out value = "${pharmacistInfo.DOB}" /></td>
                                        </tr>
                                        <tr>
                                            <th bgcolor="#008A8A">I/C NUMBER</th>
                                            <td><c:out value = "${pharmacistInfo.ic}" /></td>
                                        </tr>
                                    </table>
                                    <br><br>
