<%-- 
    Document   : pharmacistViewPatientPrescription
    Created on : Dec 23, 2019, 1:18:57 AM
    Author     : Adam
--%>
                        ...
                        <c:if test="${not empty fail}">
                            ...
                            <h1>Prescription Details</h1><br>
                                <div class = "container">                              
                                        ...
                                        <br><br><a href="PharmacistController?function=completedPrescription" class="btn btn-primary">Back</a>
                                    </div> 
                                </div>
                            </div>     
                      </div>
