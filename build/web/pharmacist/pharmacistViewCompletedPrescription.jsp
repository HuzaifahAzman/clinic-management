<%-- 
    Document   : pharmacistViewCompletedPrescription
    Created on : Dec 23, 2019, 4:31:26 PM
    Author     : Adam
--%>
    ...
    <section id="banner" class="banner">
        ...
        <div class="container">
            ...
            <table class ="table text-left">
                ...
                <c:forEach var="tempBook" items="${completedPrescription}">
                    ...
                    <c:url var="completeTask" value="PharmacistController">
                        ...
                        <tr>
                            ...
                            <td style = "color: white;" >Task Completed</td>
                        </tr>
                </c:forEach>
