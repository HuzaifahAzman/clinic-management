            ...
            <table class ="table text-left">
                <thead>
                    <tr>
                        ...
                        <th style = "color: white;" scope="col">Prescription</th>                        
                        <th style = "color: white;" scope="col">Status</th>
                    </tr>
                </thead>
                
                <c:forEach var="tempBook" items="${appointmentHistory}">
                    
                     <c:url var="prescriptionLink" value="DoctorController">
                        <c:param name="function" value="viewPatientPrescriptionPage"/>
                        ...
                        <tr>
                            ...
                            <td style = "color: white; "><a href="${prescriptionLink}" class="btn btn-primary">View Prescription</a></td>
