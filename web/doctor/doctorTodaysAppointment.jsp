    ...
    <section id="banner" class="banner">
        ...
        <div class="container">
            ...
            <table class ="table text-left">
                ...
                <c:forEach var="tempBook" items="${todaysAppointment}">
                    
                    <c:url var="prescriptionLink" value="DoctorController">
                        <c:param name="function" value="addPrescriptionPage"/>
                        ...
                        <tr>
                            ...
                            <td style = "color: white; "><a href="${prescriptionLink}"class="btn btn-primary">Prescribe Medicine</a></td>                        
                        </tr>
                </c:forEach>
