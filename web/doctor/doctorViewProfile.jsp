<%-- 
    ...
    Created on : Dec 24, 2019, 1:44:04 AM
    Author     : HP-PAVILION
--%>
                    ...
                    <div class="sign-up">
                            ...
                            <form action="DoctorController" method="post">
                                    ...
                                    <table align="center" border="1">
                                        ...
                                        <td><c:out value = "${doctorInfo.name}" /></td>
                                        </tr>
                                        <tr>
                                            <th bgcolor="#008A8A">E-MAIL</th>
                                            <td><c:out value = "${doctorInfo.email}" /></td>
                                        </tr>
                                        <tr>
                                            <th bgcolor="#008A8A">PHONE NUMBER</th>
                                            <td><c:out value = "${doctorInfo.phone}" /></td>
                                        </tr>
                                        <tr>
                                            <th bgcolor="#008A8A">DATE OF BIRTH</th>
                                            <td><c:out value = "${doctorInfo.DOB}" /></td>
                                        </tr>
                                        <tr>
                                            <th bgcolor="#008A8A">I/C NUMBER</th>
                                            <td><c:out value = "${doctorInfo.ic}" /></td>
                                        </tr>
                                    </table>
                                    <br><br>
