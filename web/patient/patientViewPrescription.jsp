<%-- 
    Document   : patientViewPrescription
    Created on : Dec 23, 2019, 9:07:03 PM
    Author     : Adam
--%>
                        ...
                        <c:if test="${not empty fail}">
                            ...
                            <h1>Prescription Details</h1><br>
                                <div class = "container">                              
                                        ...
                                        <br><br><a href="PatientController?function=viewPrescription" class="btn btn-primary">Back</a>
                                    </div> 
                                </div>
                            </div>     
                      </div>
