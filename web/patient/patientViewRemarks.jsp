<%-- 
    Document   : patientViewRemarks
    Created on : Dec 24, 2019, 1:47:42 PM
    Author     : Adam
--%>
                ...
                <div class="col-sm-4 col-md-5 col-md-offset-4">
                    <div class="sign-up">
                            <h1>Rejecting Remarks</h1><br>
                                        <%= remarks %>
                                        <br><br><p align="center"><a href="PatientController?function=viewBooking" class="btn btn-primary btn-lg" >Back</a></p>                                    
                                </div>
                             </div>     
                       </div>
                </div>
