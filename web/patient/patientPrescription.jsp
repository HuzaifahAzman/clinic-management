<%-- 
    ...
    Created on : Dec 19, 2019, 7:18:45 PM
    Author     : Adam
--%>
        ...
        <div class="bg-color">
              ...
              <div class="col-md-12">
                ...
                <div class="collapse navbar-collapse navbar-right" id="myNavbar">
                  <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="PatientController?function=viewPrescription">Prescription</a></li>
          ...
          <div class="container">
            ...
            <table class ="table text-left">
                ...
                <c:forEach var="tempBook" items="${completedPatientPrescription}">
                    
                    <c:url var="viewDetailedPrescription" value="PatientController">
                        <c:param name="function" value="viewPatientPrescription"/>
